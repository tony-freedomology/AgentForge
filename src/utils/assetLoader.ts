...
export const DEFAULT_MANIFEST: AssetManifest = {
  tiles: [
    { id: 'tile_stone_base', path: '/assets/tiles/tile_stone_base.png' },
    { id: 'tile_stone_mossy', path: '/assets/tiles/tile_stone_mossy.png' },
    { id: 'tile_grass_base', path: '/assets/tiles/tile_grass_base.png' },
    { id: 'tile_grass_flower', path: '/assets/tiles/tile_grass_flower.png' },
    { id: 'tile_grass_dense', path: '/assets/tiles/tile_grass_dense.png' },
    // Legacy/Other tiles
  ...
  props: [
    { id: 'prop_tree_oak', path: '/assets/props/prop_tree_oak.png' },
    { id: 'prop_bush_berries', path: '/assets/props/prop_bush_berries.png' },
    { id: 'prop_rock_mossy', path: '/assets/props/prop_rock_mossy.png' },
    { id: 'prop_crystal_blue', path: '/assets/props/crystal_blue.png' },
    { id: 'prop_crystal_green', path: '/assets/props/crystal_green.png' },
    { id: 'prop_crystal_purple', path: '/assets/props/crystal_purple.png' },
    { id: 'prop_torch_wall', path: '/assets/props/torch_wall.png' },
    // Portal props (regenerated)
